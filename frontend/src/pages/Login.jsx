...
const Login = () => {
  ...
  return (
    <div className="min-h-screen bg-brand-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8 relative overflow-hidden">
      <div className="absolute top-0 left-0 w-full h-full bg-brand-200/40 rounded-full mix-blend-multiply filter blur-3xl opacity-50 animate-blob pointer-events-none"></div>
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md relative z-10">
        ...
        <h3 className="mt-4 text-center text-2xl font-light text-brand-800">Inicia sesión en tu cuenta</h3>
      </div>
        ...
        <div className="bg-white/60 backdrop-blur-xl py-10 px-6 shadow-[0_8px_30px_rgb(0,0,0,0.04)] sm:rounded-3xl sm:px-12 border border-white/50">
          ...
          <div className="mt-8 text-center">
            <p className="text-sm text-brand-600">
              ...
              <Link to="/register" className="font-semibold text-brand-800 hover:text-brand-900 hover:underline">
                Regístrate aquí
              </Link>
            </p>
          </div>
